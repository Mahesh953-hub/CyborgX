...
class CyborgXClient(TelegramClient):
    def on_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func): 
            async def wrapper(check): 
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**CyborgX Error report**\n\n"
                        link = "[here](https://t.me/CyborgX)"
            ...
            if pattern is not None:
                ...
                if edited:
                    Cyborg.add_event_handler(func, events.MessageEdited(**kwargs))
                Cyborg.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                Cyborg.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                Cyborg.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
CyborgXClient.fast_download_file = download_file
CyborgXClient.fast_upload_file = upload_file
CyborgXClient.reload = restart_script
CyborgXClient.get_msg_link = get_message_link
CyborgXClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    CyborgXClient.send_message = send_message
    CyborgXClient.send_file = send_file
    CyborgXClient.edit_message = edit_message
