...
async def _(event):
    ...
    for i in animation_ttl:
        ...
        await event.eor(animation_chars[i % 4])
...
async def _(event):
    ...
    animation_chars = [
        ...
        "😡",
        "😢",
        "__**[Good to see you guys....]**__(t.me/CyborgXUpdates)",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
async def _(event):
    ...
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await event.eor(animation_chars[i % 6])
...
async def _(event):
    ...
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await event.eor(animation_chars[i % 18])
