...
from .utils import _cyborgutils
...
async def cyborg_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def cyborg_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
