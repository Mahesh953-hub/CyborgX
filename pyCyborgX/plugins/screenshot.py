...
@Cyborg.on_cmd(
    ...
    info={
        ...
        "usage": "{tr}ss <link>",
        "examples": "{tr}ss https://pornhub.com",
    },
)
async def _(event):
    ...
    try:
        ...
        inputstr = input_str
        if cmd == "ss":
            cyborgurl = url(inputstr)
            if not cyborgurl:
                inputstr = "http://" + input_str
                cyborgurl = url(inputstr)
            if not cyborgurl:
                return await cyborgevent.edit("`The given input is not supported url`")
        if cmd == "gis":
            inputstr = "https://www.google.com/search?q=" + input_str
        driver.get(inputstr)
        await cyborgevent.edit("`Calculating Page Dimensions`")
        ...
        await cyborgevent.edit("`Stoppping Chrome Bin`")
        driver.close()
        ...
        await cyborgevent.edit(f"`{traceback.format_exc()}`")
...
@Cyborg.on_cmd(
    ...
    info={
        ...
        "examples": "{tr}scapture https://pornhub.com",
    },
)
async def _(event):
    "To Take a screenshot of a website."
    ...
    if "image" in contentType:
        ...
        await cyborgevent.edit(f"`{response_api.text}`")
