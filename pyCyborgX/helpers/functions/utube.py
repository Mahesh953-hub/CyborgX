...
PATH = "./pyCyborgX/cache/ytsearch.json"
...
async def yt_search(cyborg):
    try:
        cyborg = urllib.parse.quote(cyborg)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={cyborg}"
        )
...
async def yt_data(cyborg):
    params = {"format": "json", "url": cyborg}
