...
from . import cyborgmemes, Cyborg
...
async def abusing(abused):
    "random abuse string"
    reply_text = random.choice(cyborgmemes.ABUSE_STRINGS)
...
async def fuckedd(abusehard):
    "random gali string"
    reply_text = random.choice(cyborgmemes.ABUSEHARD_STRING)
...
async def metoo(e):
    "random gali string"
    txt = random.choice(cyborgmemes.RENDISTR)
    await eor(e, txt)
...
async def chutiya(fuks):
    "random gali string"
    reply_text = random.choice(cyborgmemes.CHU_STRINGS)
...
async def thanos(thanos):
    "random gali string"
    reply_text = random.choice(cyborgmemes.THANOS_STRINGS)
...
async def kakashi(event):
    ...
    for i in animation_ttl:
        ...
        await kakashi.eor(animation_chars[i % 21])
...
async def kakashi(event):
    ...
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await kakashi.eor(animation_chars[i % 11])
...
async def kakashi(event):
    ...
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await kakashi.eor(animation_chars[i % 30])
...
async def _(event):
    "fun animation"
    cyborgevent = await eor(event, "`kiss`")
    animation_interval = 0.2
    animation_ttl = range(100)
    animation_chars = ["🤵       👰", "🤵     👰", "🤵  👰", "🤵💋👰"]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await cyborgevent.eor(animation_chars[i % 4])
...
async def _(event):
    "fun animation"
    cyborgevent = await eor(event, "`fuking....`")
    animation_interval = 0.2
    animation_ttl = range(100)
...
async def _(event):
    "fun animation"
    cyborgevent = await eor(event, "`sex`")
    animation_interval = 0.2
    animation_ttl = range(100)
    animation_chars = ["🤵       👰", "🤵     👰", "🤵  👰", "🤵👼👰"]
    for i in animation_ttl:
...
async def kakashi(event):
    ...
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await kakashi.eor(animation_chars[i % 6])
