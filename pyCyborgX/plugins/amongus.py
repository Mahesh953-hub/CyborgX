...
async def _(event):
    ...
    await asyncio.sleep(2)
    await text4.eor("**Others :** Who?? ")
    await asyncio.sleep(2)
    await text4.eor(
        f"**[{ALIVE_NAME}]({USERNAME}) :** Its {name} , I saw {name}  using vent,"
    )
    await asyncio.sleep(3)
    await text4.eor(f"**Others :**Okay.. Vote {name} ")
    await asyncio.sleep(2)
    await stcr3.delete()
    await text4.delete()
    ...
    cyborgevent = await event.reply(f"{name} is ejected.......")
    await asyncio.sleep(2)
    await cyborgevent.eor("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await cyborgevent.eor("ㅤඞㅤㅤㅤㅤ ㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await cyborgevent.eor("ㅤㅤ ඞㅤㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await cyborgevent.eor("ㅤㅤㅤ ඞㅤㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await cyborgevent.eor("ㅤㅤㅤㅤ ඞㅤㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await cyborgevent.eor("ㅤㅤㅤㅤㅤ ඞㅤㅤㅤ")
    await asyncio.sleep(0.5)
    await cyborgevent.eor("ㅤㅤㅤㅤㅤㅤ ඞㅤㅤ")
    await asyncio.sleep(0.5)
    await cyborgevent.eor("ㅤㅤㅤㅤㅤㅤㅤ ඞㅤ")
    await asyncio.sleep(0.5)
    await cyborgevent.eor("ㅤㅤㅤㅤㅤㅤㅤㅤ ඞ")
    await asyncio.sleep(0.5)
    await cyborgevent.eor("ㅤㅤㅤㅤㅤㅤㅤㅤ ㅤ")
...
async def _(event):
    ...
    name = event.pattern_match.group(2)
    cmd = event.pattern_match.group(1).lower()
    cyborgevent = await eor(event, f"{name} is ejected.......")
    await asyncio.sleep(2)
    await cyborgevent.eor("ඞㅤㅤㅤㅤ ㅤㅤㅤㅤ")
