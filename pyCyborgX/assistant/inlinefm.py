...
from pyCyborgX.Config import Config
from pyCyborgX..funcs.decorators import check_owner
from pyCyborgX.helpers import humanbytes, progress
from pyCyborgX.helpers.utils import _cyborgutils
...
@Cyborg.tgbot.on(CallbackQuery(pattern="fmback"))
@check_owner
...
@Cyborg.tgbot.on(CallbackQuery(pattern="fmup_(.*)"))
@check_owner
async def up(event):
...
@Cyborg.tgbot.on(CallbackQuery(pattern="fmdown_(.*)"))
@check_owner
...
@Cyborg.tgbot.on(CallbackQuery(pattern="fmforth_(.*)"))
@check_owner
...
@Cyborg.tgbot.on(CallbackQuery(pattern="fmrem_(.*)"))
@check_owner
async def remove(event):
    ...
    await asyncio.sleep(1)
    await event.edit(msg, buttons=buttons)
    await _cyborgutils.runcmd(f"rm -rf '{rpath}'")
    await event.answer(f"{rpath} removed successfully...")



@Cyborg.tgbot.on(CallbackQuery(pattern="fmsend"))
@check_owner
...
@Cyborg.tgbot.on(CallbackQuery(pattern="fmcut_(.*)"))
@check_owner
async def cut(event):
...
@Cyborg.tgbot.on(CallbackQuery(pattern="fmcopy_(.*)"))
@check_owner
...
@Cyborg.tgbot.on(CallbackQuery(pattern="fmpaste_(.*)"))
@check_owner
